						...
						if (isset($_POST['submit']))
							{
								...
								{
									header("Location: auth_supplier.php?attempt=empty");
								}
								else{
									...
									if ($result = mysqli_query($con,$sql)) 
									{
										...
										{
											header("Location: auth_supplier.php?attempt=exist");	
										}
										else{
											
											$sql = mysqli_query($con,"INSERT INTO supplier (supplier_name,address,contact_person,contact,email) 
																values('$name','$address','$person','$contact','$email')",$conn) 
																or die("Could not execute the insert query.");
											
											header("Location: auth_supplier.php?attempt=saved");
										}
									}
								}
							}
