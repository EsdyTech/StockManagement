...
//$a=$_POST['dayfrom'];
if($_POST['monthly']=='New Items'){

echo '<br>
<div align="center">New Item Report From:<strong>"'.$_POST['dayfrom'].'"</strong>&nbsp;&nbsp;To:<strong>"'.$_POST['dayto'].'"
<br />
    </strong></div>';
...
$result1 = mysqli_query($con,"SELECT * FROM itemlist WHERE dateadded BETWEEN '$a' AND '$b'");
$grandTotal =0;
...
else if($_POST['monthly']=='Supplied Items'){

echo '<br>
<div align="center">Supplied Items Report For:<strong>"'.$_POST['dayfrom'].'"</strong>&nbsp;&nbsp;To:<strong>"'.$_POST['dayto'].'"
<br />
    </strong></div>';
...
$result1 = mysqli_query($con,"SELECT * FROM supplied WHERE supplied_date BETWEEN '$a' AND '$b'");
$grandTotal = 0;
while($row = mysqli_fetch_array($result1))
{
...
else if($_POST['monthly']=='Added Items'){

echo '<br>
<div align="center">Added Items Report For:<strong>"'.$_POST['dayfrom'].'"</strong>&nbsp;&nbsp;To:<strong>"'.$_POST['dayto'].'"
<br />
    </strong></div>';
...
$result1 = mysqli_query($con,"SELECT * FROM added_item WHERE date_added BETWEEN '$a' AND '$b'");
$grandTotal = 0;
...
else if($_POST['monthly']=='Requested Items'){
...
$result1 = mysqli_query($con,"SELECT * FROM request WHERE date BETWEEN '$a' AND '$b'");
$grandTotal = 0;
